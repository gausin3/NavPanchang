...
**All originally-planned phases are now implemented in code.** What remains is
non-code: the bundled `R.raw.ritual_*.ogg` audio assets (currently using system
default sound) and the Play Store 12-tester / 14-day Closed Testing cycle before
